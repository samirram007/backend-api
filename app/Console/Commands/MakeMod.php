...
use App\Modules\\{$name}\Facades\\{$name}Facade as {$name};
...
";
    ...
    private function createFacade(string $modulePath, string $name, string $plural): void
    {

        $content = "<?php
        namespace App\Modules\\{$name}\Facades;
